...
<html lang="en">
<?php
$init="DBManagementProject.localhostByShrutDogra";
?>
<head>
...
<body>
<img src="hands.jpg" height="50" width="50";/><p style="text-align:right"><?php echo$init;?></p>
<div id="upper">
    <ul>
	   ...
	   if(isset($_GET['i']))
	   {
		   ...
		   case "1": include("home.php");
			...
			case "3": include("registeradmin.php");
						break;
			case "4": include("registration.php");
						break;
